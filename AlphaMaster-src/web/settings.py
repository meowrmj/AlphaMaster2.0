...
_DEFAULT = {
    "last_data_file": "",
    "data_root_dir": str(PROJECT_ROOT.parent / "AlphaMaster-data" / "parquet"),
    "last_strategy_file": "",
    "debug_mode": False,
...
def save_settings(data: dict) -> dict:
    ...
    if "data_root_dir" in data:
        current["data_root_dir"] = str(data["data_root_dir"] or "").strip()
    ...
    if "realtime_source" in data:
        current["realtime_source"] = str(data["realtime_source"] or "").strip() or "tradingview"
