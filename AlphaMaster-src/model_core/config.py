...
class ModelConfig:
    ...
    BEHAVIOR_CORR_THRESHOLD: float = float(os.getenv("ALPHAMASTER_BEHAVIOR_CORR_THRESHOLD", "0.900"))
    BEHAVIOR_CORE_CORR_THRESHOLD: float = float(os.getenv("ALPHAMASTER_BEHAVIOR_CORE_CORR_THRESHOLD", "0.875"))
